...
add_action( 'init', function() {
  ...
  register_post_type('verhalen',
      array(
          'labels' => array(
              'name' => __('Verhalen', 'smdzr'),
              'singular_name' => __('Verhalen', 'smdzr'),
          ),
          'public' => true,
          ...
          'supports' => array(
              'title', 'editor', 'revisions', 'thumbnail', 'page-attributes', 'custom-fields',  'dashicons-groups'),
          ...
          'rewrite' => array(
              ...
              'with_front' => false ),
          'query_var' => true,
          //https://github.com/Clark-Nikdel-Powell/page-for-post-types
